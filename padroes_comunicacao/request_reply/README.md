...
│
├── requester-service/                            porta 8085
│   └── src/main/java/com/algasensors/requester/
...
│
└── replier-service/                              porta 8086
    └── src/main/java/com/algasensors/replier/
...
Class not found [com.algasensors.replier.dto.PessoaResponseDTO]
```
...
```
__TypeId__ = com.algasensors.replier.dto.PessoaResponseDTO
```
...
em `com.algasensors.requester.dto.PessoaResponseDTO`. Resultado: exceção.
...
Requester tenta:
  Class.forName("com.algasensors.replier.dto.PessoaResponseDTO") → ClassNotFoundException
```
